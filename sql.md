-- Generated from prisma/schema.prisma (empty -> full schema)
CREATE DATABASE IF NOT EXISTS `partner_db` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE `partner_db`;
